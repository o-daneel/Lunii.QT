...
#### Windows & MacOS
   ...
   **NOTE 1:** The FFMPEG binary is no longer included by default in the archives.  
   **NOTE 2:** You can get a more recent version using the same menu.  
...
#### Personnal backup (ZIP / 7z) [TYPE_FLAM_ZIP/TYPE_FLAM_7z]
