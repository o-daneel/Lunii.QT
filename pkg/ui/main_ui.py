...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icon/res/top.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionMove_Top.setIcon(icon6)
        self.actionMove_Bottom = QAction(MainWindow)
        self.actionMove_Bottom.setObjectName(u"actionMove_Bottom")
        icon7 = QIcon()
        icon7.addFile(u":/icon/res/bottom.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionMove_Bottom.setIcon(icon7)
        self.actionOpen_Lunii = QAction(MainWindow)
        self.actionOpen_Lunii.setObjectName(u"actionOpen_Lunii")
        icon8 = QIcon()
        icon8.addFile(u":/icon/res/open.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionOpen_Lunii.setIcon(icon8)
        self.actionShow_Log = QAction(MainWindow)
        self.actionShow_Log.setObjectName(u"actionShow_Log")
        self.actionAbout = QAction(MainWindow)
        self.actionAbout.setObjectName(u"actionAbout")
        icon9 = QIcon()
        icon9.addFile(u":/icon/res/about.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icon/res/refresh.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icon/res/refresh_db.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_db.setIcon(icon11)
