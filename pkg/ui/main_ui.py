...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icon/res/refresh.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icon/res/refresh_db.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_db.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icon/res/about.png", QSize(), QIcon.Normal, QIcon.Off)
