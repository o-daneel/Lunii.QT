...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon9 = QIcon()
        icon9.addFile(u":/icon/res/refresh.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icon/res/refresh_db.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_db.setIcon(icon10)
