...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", "Lunii Qt-Manager", None))
        self.actionExit.setText(QCoreApplication.translate("MainWindow", "Exit", None))
        self.actionImport.setText(QCoreApplication.translate("MainWindow", "Import", None))
        self.actionExport.setText(QCoreApplication.translate("MainWindow", "Export", None))
        self.actionExport_All.setText(QCoreApplication.translate("MainWindow", "Export All", None))
        self.actionMove_Up.setText(QCoreApplication.translate("MainWindow", "Move Up", None))
        self.actionMove_Down.setText(QCoreApplication.translate("MainWindow", "Move Down", None))
        self.actionRemove.setText(QCoreApplication.translate("MainWindow", "Remove", None))
        self.actionShow_size.setText(QCoreApplication.translate("MainWindow", "Show size", None))
#if QT_CONFIG(tooltip)
        self.actionShow_size.setToolTip(QCoreApplication.translate("MainWindow", "Show size for each stories", None))
#endif // QT_CONFIG(tooltip)
        self.actionGet_firmware.setText(QCoreApplication.translate("MainWindow", "Get FW Update", None))
#if QT_CONFIG(tooltip)
        self.actionGet_firmware.setToolTip(QCoreApplication.translate("MainWindow", "Get firmaware update for current Lunii", None))
#endif // QT_CONFIG(tooltip)
        self.actionShow_story_details.setText(QCoreApplication.translate("MainWindow", "Show story details", None))
        self.actionMove_Top.setText(QCoreApplication.translate("MainWindow", "Move Top", None))
        self.actionMove_Bottom.setText(QCoreApplication.translate("MainWindow", "Move Bottom", None))
        self.actionOpen_Lunii.setText(QCoreApplication.translate("MainWindow", "Open device", None))
#if QT_CONFIG(tooltip)
        self.actionOpen_Lunii.setToolTip(QCoreApplication.translate("MainWindow", "Open Lunii or Flam device", None))
#endif // QT_CONFIG(tooltip)
        self.actionShow_Log.setText(QCoreApplication.translate("MainWindow", "Show Log", None))
        self.actionAbout.setText(QCoreApplication.translate("MainWindow", "About", None))
        self.actionUpdate.setText(QCoreApplication.translate("MainWindow", "Update to v2.X.X", None))
        self.actionTranscode.setText(QCoreApplication.translate("MainWindow", "FFMPEG detected", None))
        self.actionRecover_stories.setText(QCoreApplication.translate("MainWindow", "Recover", None))
        self.actionRemove_stories.setText(QCoreApplication.translate("MainWindow", "Remove", None))
        self.actionFactory_reset.setText(QCoreApplication.translate("MainWindow", "Factory Reset", None))
        self.actionFind_stories.setText(QCoreApplication.translate("MainWindow", "Find", None))
        self.actionHide.setText(QCoreApplication.translate("MainWindow", "Hide / Show", None))
        self.actionImport_DB.setText(QCoreApplication.translate("MainWindow", "Import STUdio DB", None))
        self.actionRefresh_DB.setText(QCoreApplication.translate("MainWindow", "Refresh official DB", None))
        self.actionNight_Mode.setText(QCoreApplication.translate("MainWindow", "Force Night Mode", None))
#if QT_CONFIG(tooltip)
        self.btn_refresh.setToolTip(QCoreApplication.translate("MainWindow", "Refresh connected devices", None))
#endif // QT_CONFIG(tooltip)
        self.btn_refresh.setText("")

#if QT_CONFIG(tooltip)
        self.combo_device.setToolTip(QCoreApplication.translate("MainWindow", "Select your Lunii", None))
#endif // QT_CONFIG(tooltip)
        self.combo_device.setPlaceholderText(QCoreApplication.translate("MainWindow", "Select your Lunii", None))
#if QT_CONFIG(shortcut)
        self.btn_nightmode.setShortcut(QCoreApplication.translate("MainWindow", u"Backspace", None))
#endif // QT_CONFIG(shortcut)
        self.le_filter.setPlaceholderText(QCoreApplication.translate("MainWindow", "(Story Name or UUID filter text)", None))
#if QT_CONFIG(tooltip)
        self.btn_db.setToolTip(QCoreApplication.translate("MainWindow", "Force official Lunii DB to be refreshed", None))
#endif // QT_CONFIG(tooltip)
        self.btn_db.setText("")
        ___qtreewidgetitem = self.tree_stories.headerItem()
        ___qtreewidgetitem.setText(4, QCoreApplication.translate("MainWindow", "Size", None));
        ___qtreewidgetitem.setText(0, QCoreApplication.translate("MainWindow", "Story Name", None));
#if QT_CONFIG(tooltip)
        ___qtreewidgetitem.setToolTip(2, QCoreApplication.translate("MainWindow", "Database source (Official / Third Party)", None));
        ___qtreewidgetitem.setToolTip(1, QCoreApplication.translate("MainWindow", "Night Mode", None));
#endif // QT_CONFIG(tooltip)
        ...
        self.lbl_total.setText(QCoreApplication.translate("MainWindow", "Total", None))
#if QT_CONFIG(tooltip)
        self.btn_abort.setToolTip(QCoreApplication.translate("MainWindow", "Abort current process", None))
#endif // QT_CONFIG(tooltip)
        self.btn_abort.setText("")
        self.lbl_picture.setText(QCoreApplication.translate("MainWindow", "No Thumb", None))
        self.te_story_details.setPlaceholderText(QCoreApplication.translate("MainWindow", "Story description", None))
        self.menuFile.setTitle(QCoreApplication.translate("MainWindow", "&File", None))
        self.menuTools.setTitle(QCoreApplication.translate("MainWindow", "&Tools", None))
        self.menuLost_stories.setTitle(QCoreApplication.translate("MainWindow", "Lost stories", None))
        self.menuStory.setTitle(QCoreApplication.translate("MainWindow", "&Stories", None))
        self.menuUpdate.setTitle(QCoreApplication.translate("MainWindow", "Update 2.2.X is released", None))
