...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionRecover = QAction(MainWindow)
        self.actionRecover.setObjectName(u"actionRecover")
        self.actionClean_up = QAction(MainWindow)
        self.actionClean_up.setObjectName(u"actionClean_up")
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icon/res/refresh.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_refresh.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icon/res/refresh_db.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_db.setIcon(icon14)
        ...
        self.menuTools.addSeparator()
        self.menuTools.addAction(self.actionRecover)
        self.menuTools.addAction(self.actionClean_up)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionRecover.setText(QCoreApplication.translate("MainWindow", u"Recover lost stories", None))
        self.actionClean_up.setText(QCoreApplication.translate("MainWindow", u"Clean up storage", None))
